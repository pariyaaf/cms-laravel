...
?>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="page-header head-section">
            <h2>
                ایجاد اپیزود
                <!-- <a href="{{route('admin.episode.create')}}" class="btn btn-primary">ایجاد دوره جدید</a> -->
            </h2>
        </div>
        <div class="table-responsive">
   

            <form class="form-horizontal"action="{{route('admin.episode.store')}}" method="post" enctype="multipart/form-data">
                @csrf
